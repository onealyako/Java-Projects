...
/*Change cis2430 in this string to be your login name.  Leave the rest of the string intact */
	...
	public static final String DB_URL = "jdbc:mysql://dursley.socs.uoguelph.ca:3306/oyako?useLegacyDatetimeCode=false&serverTimezone=America/New_York";


/*Change the username to be your own login name */

	public static final String username = "oyako";
